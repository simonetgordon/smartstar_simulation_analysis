...
from plot_multipanel_time_2 import configure_font, make_projection_plot, create_axes_grid, set_axis_labels_and_colorbar, \
    configure_projection_plot, get_min_max_values
...
def main(root_dir, sim, dds1, dds2, dds3, field, width_pc, xticks, fontsize, min_n_factor=2e5, max_n_factor=0.30, cmap="viridis"):
    ...
    configure_font()
    fig = plt.figure()
    grid = create_axes_grid(fig, nrows=2, ncols=2, dim=(0, 0, 0.5, 0.5))
    ...
    for i, ds in enumerate(DS):
        ...
        for j in [0,1]:
            ...
            p = make_projection_plot(ds, width_pc, disk, L, field, vecs, v, north, min_n, max_n, fontsize, cmap=cmap)
            ...
            if ((i == 0) or (i == 2) or (i == 4) or (i == 6)) and ((j == 0) or (j == 2)):
        ...
        # save
        plot_name = 'projection-res-' + str(LABEL[i]) + '-' + str(field) + '-' + 's2' + '.png'
...
if __name__ == "__main__":
    ...
    dds3 = ["DD0228/DD0228", "DD0268/DD0268", "DD0278/DD0278"]  # 0.201, 0.801, 1.002 Myr for b01
    fontsize = 14
