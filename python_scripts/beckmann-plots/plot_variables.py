...
if __name__ == "__main__":
    ...
    smooth_simulations = 6  # number of simulations to smooth (starting from last sim)
    ...
    c_s2 = extract_colors('magma', 4, portion="middle", start=0.25, end=0.8)
