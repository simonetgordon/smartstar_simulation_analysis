...
c2 = ['#d46a7e', 'lightblue', 'lightgreen', 'khaki', 'plum', 'seagreen', 'steelblue', 'salmon']
# purple/lavender, greeny-blue, light green, dusky-pink/darker pink, mustard yellow, classic blues, fuschia/burgundy
c1 = ['#856798', '#0a888a', '#56ae57', '#ba6873', '#ffc512', '#436bad', '#9d0759', '#9d0216', '#7bc8f6', '#d0c101',
      '#c4387f','#7bb274', '#06b48b', '#6c3461']
c = plt.cm.Pastel1(np.linspace(0, 1, len(bhl_object_list)))
l = bhl_object_labels
