...
# macros
x = "seed2-bh-only-" # plot number
y = sys.argv[-1]
mass_density = True # to create volume-weight radial profiles
star_pos0 = [0.49892526, 0.49581933, 0.49128109] # found with smartstar-find.py

# load data
root_dir = "/home/sgordon/disk14/cirrus-runs-rsync/seed2-bh-only/270msun/BF-0.0078125"
