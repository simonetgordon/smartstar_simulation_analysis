...
# load data
root_dir = "/home/sgordon/disk14/cirrus-runs-rsync/seed3-bh-only/270msun/BF-0.0078125"
...
label1 = sys.argv[1]
DD.append(ds1)
ds2 = yt.load(os.path.join(root_dir, sys.argv[2])) # later time ~ 4400 yrs old
label2 = sys.argv[2]
DD.append(ds2)
if str(sys.argv[3]).startswith('DD'):
    ds3 = yt.load(os.path.join(root_dir, sys.argv[3])) # later time ~ 4400 yrs old
    label3 = sys.argv[3]
    DD.append(ds3)
