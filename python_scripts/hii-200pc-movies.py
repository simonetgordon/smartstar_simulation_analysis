...
if __name__ == "__main__":
    ...
    if nested_level == 0:
        region = None
        center0 = [0.49053251, 0.4946698,  0.50963437]
        width = None
    else:
...
#        p3.save("frames_h2-hii/")
        ...
        p4 = yt.ProjectionPlot(ds, "x", ("gas", 'H_p1_fraction'), width=(200, 'pc'), center= center, data_source=region, weight_field='cell_mass')
